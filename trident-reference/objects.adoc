...
| VolumeBindingMode | cadeia de carateres | Imediato, WaitForFirstConsumer | Escolha quando ocorre a vinculação de volume e o provisionamento dinâmico | Tudo | 1,19 - 1,24 
|===
[TIP]
====
